...
public class test {
	...
	public static double[][] d = new double[16][16];		//对数据的第二次处理
	...
	private void initialize() {
					...
					Runnable xiancheng2 = new Runnable(){
						...
						public void run() {
							...
							try{
								...
								//第二次处理数据
								//将数组c[16][66]通过计算后得到信号频率，并赋值给d[16][16]
								int x = 1;
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] {
					"序号", "CH01", "CH02", "CH03", "CH04", "CH05", "CH06", "CH07", "CH08", "CH09", "CH10", "CH11", "CH12", "CH13", "CH14", "CH15", "CH16"
				}
			));
